...
export class CpuClient {
    ...
    getCpu(name_Operator?: ConditionType | null | undefined, name_Values?: string[] | undefined, sortProperty?: string | null | undefined, sortDirection?: SortType | null | undefined, pageNumber?: number | null | undefined, pageSize?: number | null | undefined): Observable<PagedResponseOfListOfCpuDTO> {
        let url_ = this.baseUrl + "/api/cpu?";
        if (name_Operator !== undefined && name_Operator !== null)
            url_ += "Name.Operator=" + encodeURIComponent("" + name_Operator) + "&";
        if (name_Values === null)
            throw new globalThis.Error("The parameter 'name_Values' cannot be null.");
        else if (name_Values !== undefined)
            name_Values && name_Values.forEach(item => { url_ += "Name.Values=" + encodeURIComponent("" + item) + "&"; });
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCpu(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCpu(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PagedResponseOfListOfCpuDTO>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PagedResponseOfListOfCpuDTO>;
        }));
    }

    protected processGetCpu(response: HttpResponseBase): Observable<PagedResponseOfListOfCpuDTO> {
        ...
        if (status === 200) {
            ...
            result200 = PagedResponseOfListOfCpuDTO.fromJS(resultData200);
...
export class PagedResponseOfListOfCpuDTO implements IPagedResponseOfListOfCpuDTO {
    data?: CpuDTO[] | undefined;
    pageNumber?: number;
    pageSize?: number;
    totalRecords?: number;

    constructor(data?: IPagedResponseOfListOfCpuDTO) {
        if (data) {
    ...
    static fromJS(data: any): PagedResponseOfListOfCpuDTO {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResponseOfListOfCpuDTO();
        result.init(data);
        return result;
    }
...
export interface IPagedResponseOfListOfCpuDTO {
    data?: CpuDTO[] | undefined;
    pageNumber?: number;
    pageSize?: number;
    totalRecords?: number;

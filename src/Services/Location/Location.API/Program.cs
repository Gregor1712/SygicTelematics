...
{
    var httpPort = builder.Configuration.GetValue("HttpPort", 5104);
    var grpcPort = builder.Configuration.GetValue("GrpcPort", 6104);
...
app.MapGrpcService<Location.API.GrpcServices.LocationGrpcService>();
app.MapControllers();
...
try
{
    var context = services.GetRequiredService<LocationDbContext>();
